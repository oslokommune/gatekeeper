...
generate-dotenv-file: ## Generate .env file template
	...
	@echo "TOKEN_COOKIES_DOMAIN=́ #optional, default BASE_URL" >> .env
	@echo "TOKEN_COOKIES_PREFIX= #optional" >> .env
	@echo "TOKEN_COOKIES_SAMESITE= #optional, default strict" >> .env
	@echo "TOKEN_COOKIES_SECURE= #optional, default 'true'" >> .env
